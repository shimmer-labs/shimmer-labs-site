      ...
      <div class="project-main">
        ...
        <div class="project-hero-cta">
          <?php if ($page->is_app()->toBool()): ?>
            ...
            <?php if ($hasShopify): ?>
              <a href="<?= $page->shopify_app_url() ?>" class="btn btn--shopify btn--hero" target="_blank" rel="noopener">
                <svg width="22" height="22" viewBox="0 0 109.5 124.5" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
          ...
          <?php else: ?>
            <?php if ($page->link()->isNotEmpty()): ?>
              <a href="<?= $page->link() ?>" class="btn btn--cta btn--hero" target="_blank" rel="noopener">
                View Live Project
              </a>
            <?php endif ?>
          <?php endif ?>
