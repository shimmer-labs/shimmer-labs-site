...
<section class="oh-cta">
  <div class="container">
    ...
    <p class="oh-cta__subtext">Or make it a standing thing: the <a href="<?= url('services/concierge') ?>">AI Concierge</a> is two working sessions a month with text access in between. $1,000/mo, and the first 5 clients get $750/mo.</p>
