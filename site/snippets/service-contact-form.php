    ...
    <div class="service-contact-form__content">
      <div class="service-contact-form__header">
        ...
        <?php if (!empty($ctaDescription)): ?>
          <p><?= $ctaDescription ?></p>
        <?php else: ?>
          <p>Start with the free Snapshot call. We'll give you a straight answer on cost and timeline.</p>
        <?php endif ?>
      </div>
      ...
      <iframe src="https://api.leadconnectorhq.com/widget/booking/tCHB0sj6MoYpJYWJyVqd"
              ...
              scrolling="no" id="ghl-booking-service" title="Book a free Snapshot call with Shimmer Labs"></iframe>
